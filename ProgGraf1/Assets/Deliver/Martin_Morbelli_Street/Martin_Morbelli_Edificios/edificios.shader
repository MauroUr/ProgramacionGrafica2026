...
Shader "edificios"
{
	Properties
	{
		...
		_EscalaEdificio("EscalaEdificio", Vector) = (0,0,0,0)
	...
	SubShader
	{
		...
		uniform float2 _EscalaEdificio;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 triplanar6 = TriplanarSampling6( _TopTexture0, ase_worldPos, ase_worldNormal, 1.0, _EscalaEdificio, 1.0, 0 );
