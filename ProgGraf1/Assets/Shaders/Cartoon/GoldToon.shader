...
Shader "GoldToon"
{
	Properties
	{
		...
		_Luz("Luz", Color) = (0.8867924,0.8247297,0.07111073,1)
		_Sombra("Sombra", Color) = (0.5566038,0.5164509,0.02888039,1)
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 lerpResult8 = lerp( _Luz , _Sombra , step( dotResult3 , _umbralSombra ));
